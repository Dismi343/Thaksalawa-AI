...
// Using a simple book icon placeholder
const BookIcon = () => (
  <svg
...
const LessonCard = ({ lessonNumber, grade }) => {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden cursor-pointer hover:shadow-lg transition duration-300 w-full max-w-sm">
      ...
      <div className="bg-slate-700 h-24 flex items-center justify-center p-6">
        <BookIcon />
      </div>

      {/* Text Content */}
      <div className='p-4'>
        <p className="text-lg font-semibold text-gray-800 mb-1">{`Lesson ${lessonNumber}`}</p>
